...
const Projects = () => {
  ...
  const [projects, setProjects] = useState<Project[]>([
    { id: '1', title: 'Untitled Project', sources: 12, widgets: 6, updatedAt: '12h ago' },
    { id: '2', title: 'Untitled Project', sources: 12, widgets: 6, updatedAt: '30+ days ago' },
    { id: '3', title: 'Untitled Project', sources: 12, widgets: 6, updatedAt: '30+ days ago' },
  ]);
  ...
  const handleProjectClick = (projectId: string) => {
    navigate('/dashboard?projectId=' + projectId); // change to use pathParams from react-router-dom? 
  };
      ...
      <Container maxWidth="lg" sx={{ mt: 6, pb: 8 }}>
        <Paper elevation={0} sx={{ 
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            <Typography variant="h4" component="h1" sx={{ fontWeight: 'none', color: 'hsl(var(--text-primary))' }}>
              Projects
            </Typography>
            <Button
              variant="contained"
          ...
          <Typography variant="body1" sx={{ color: 'hsl(var(--accent))', mb: 3, textAlign: 'start' }}>
            ...
            {projects.map((project) => (
              ...
              >
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <Typography variant="h6" sx={{color: 'hsl(var(--text-primary))'}}>{project.title}</Typography>
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 11C8.76142 11 11 8.76142 11 6C11 3.23858 8.76142 1 6 1C3.23858 1 1 3.23858 1 6C1 8.76142 3.23858 11 6 11Z" stroke="#666666" stroke-opacity="0.77" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M6 3.5V6L7.5 7.5" stroke="#666666" stroke-opacity="0.77" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    </Box>
                    <Typography variant="body2" sx={{ color: 'hsl(var(--accent))' }}>
                      {project.updatedAt}
                    </Typography>
                  </Box>
                </Box>
