    ...
    <Container maxWidth="xl" disableGutters sx={{ minHeight: '100vh', display: 'flex' }}>
      ...
      <Box sx={{ 
        ...
        <Box sx={{ maxWidth: 480, width: '100%', mx: 'auto'}}>
          <Typography variant="h4" component="h1" sx={{ fontWeight: 'none', mb: 1, textAlign: 'start' }}>
            Log in
          </Typography>
          ...
          <Box sx={{ mb: 3, display: 'flex', gap: 2 }}>
            ...
            <Button
              ...
              startIcon={
                <Box component="span" sx={{ display: 'flex', alignItems: 'center' }}>
                  <svg width="18" height="18" viewBox="0 0 170 170" fill="black">
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ mt: 3 }}>
            ...
            <Box sx={{ mb: 1 }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                <Typography variant="body1" component="label" htmlFor="password" sx={{ fontWeight: 500, textAlign: 'start' }}>
                  Password
                </Typography>
                <MuiLink 
                  component={Link}
                  to="/forgot-password"
                  underline="none" 
                  sx={{ color: '#B066FF', fontSize: '0.875rem' }}
                >
                  Forgot password?
                </MuiLink>
              </Box>
