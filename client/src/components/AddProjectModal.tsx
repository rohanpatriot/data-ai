...
const AddProjectModal: React.FC<AddProjectModalProps> = ({ open, onClose, onAdd }) => {
    ...
    const handleAdd = () => {
      ...
      return (
        ...
        >
          <DialogTitle variant="h4" sx={{ fontWeight: 'bold', mb: 0.5, color: '#293133' }}>Add Project</DialogTitle>
          <DialogContent>
            <Box sx={{ mb: 2 }}>
              <Box sx={{ mb: 1 }}>
                <Box component="label" sx={{ fontWeight: 'medium', fontSize: '1.1rem', mb: 1, display: 'block', color: '#293133' }}>
                  Name
                </Box>
                <TextField
                  fullWidth
